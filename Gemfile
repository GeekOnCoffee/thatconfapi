...
gem 'administrate-field-enum', git: 'https://github.com/headwayio/administrate-field-enum.git'
gem 'administrate-field-hex_color_picker'
gem 'administrate-field-nested_has_many', git: 'https://github.com/headwayio/administrate-field-nested_has_many', branch: 'rails_5'
